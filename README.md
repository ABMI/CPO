...
2. Create an empty folder or new RStudio project, and in `R`, use the following code to install the study package and its dependencies:
    ...
    download.file("https://raw.githubusercontent.com/ohdsi-studies/CPO/main/renv.lock", "renv.lock")
    renv::init()
    ```  
...
License
=======
The CPO package is licensed under Apache License 2.0

Development
===========
CPO was developed in ATLAS and R Studio.
